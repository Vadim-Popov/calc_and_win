...
class Ockoshnick(Character):
    BRIEF_DESC_CHAR_CLASS = (' ебучий очкошник. '
                             'Съебывается с такой скоростью что все в ахуе')
    RANGE_VALUE_ATTACK = (1, 4)
    RANGE_VALUE_DEFENCE = (1, 3)
    SPECIAL_BUFF = DEFAULT_DEFENCE + 30
    SPECIAL_SKILL = 'Хуйнуть с подливой'


...
ockoshnick = Ockoshnick('Обосранец')
print(ockoshnick)
print(ockoshnick.attack())
